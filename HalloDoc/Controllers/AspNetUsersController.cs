...
namespace HalloDoc.Controllers
{
    public class AspNetUsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserName,PasswordHash,Email,PhoneNumber,Ip,CreatedDate,ModifiedDate,ModifiedBy")] AspNetUser aspNetUser)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserName,PasswordHash,Email,PhoneNumber,Ip,CreatedDate,ModifiedDate,ModifiedBy")] AspNetUser aspNetUser)
        {
            if (id != aspNetUser.Id)
            {
                return NotFound();
